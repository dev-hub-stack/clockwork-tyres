...
var pq = $.paramquery, 
    ...
    grid = pq.pqGrid.regional[local] = {
        ...
        strFormulas: {
            ...
            COUNTIFS:  ["COUNTIFS(criteria_range1, criteria1, [criteria_range2, criteria2]â€¦)","Applies criteria to cells across multiple ranges and counts the number of times all criteria are met."],
