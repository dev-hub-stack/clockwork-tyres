        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; border-bottom: 3px solid #1a1a2e; padding: 28px 35px;">
            <tr>
                <td width="50%" style="vertical-align: middle;">
                    <h1 style="color: #1a1a2e; font-size: 26px; font-weight: 700; letter-spacing: 2px; margin: 0;">INVOICE</h1>
                    <p style="color: #666; font-size: 13px; margin-top: 4px; margin-bottom: 0;">{{ $docNumber }}</p>
                </td>
                ...
                <tr>
                    ...
                    <td style="width: 20%; padding: 6px 0; vertical-align: top;">
                        ...
                        <div style="font-size: 13px; font-weight: 600; color: #222; margin-top: 3px;">
                            {{ $record->payment_term?->label() ?? '30 Days' }}
                        </div>
                    </td>
                    <td style="width: 20%; padding: 6px 0; vertical-align: top;">
                        ...
                        <div style="font-size: 13px; font-weight: 600; color: #222; margin-top: 3px;">
                            {{ $record->valid_until
                                ? \Carbon\Carbon::parse($record->valid_until)->format('M d, Y')
                                : (\App\Modules\Customers\Enums\PaymentTerm::default()->dueDateFrom($record->issue_date ?? $record->created_at))->format('M d, Y') }}
                        </div>
                    </td>
