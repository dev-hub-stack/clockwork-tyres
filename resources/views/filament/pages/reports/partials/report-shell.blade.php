...
<div class="report-page">
    ...
    <x-report-toolbar
        ...
        :brands="$toolbar['brands']"
        :categories="$toolbar['categories']"
        :dealers="$toolbar['dealers']"
        :users="$toolbar['users']"
        :show-brand-filter="$toolbar['showBrandFilter']"
        :show-category-filter="$toolbar['showCategoryFilter']"
        :show-search-filter="$toolbar['showSearchFilter']"
        :search-placeholder="$toolbar['searchPlaceholder']"
        ...
        :export-csv-url="$toolbar['exportCsvUrl'] ?? null"
        :export-pdf-url="$toolbar['exportPdfUrl'] ?? null"
    />
